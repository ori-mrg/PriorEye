...
subscore_folder=dp_subscore_${TRAIN_TEST_SPLIT}
experiment_name=dp_prioreye_${TRAIN_TEST_SPLIT}

export DP_PREDS=none
export SUBSCORE_PATH=${NAVSIM_EXP_ROOT}/${subscore_folder}/dp_${TRAIN_TEST_SPLIT}.pkl # save path for the dp-generated trajectories
