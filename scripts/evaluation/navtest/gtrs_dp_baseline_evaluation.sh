...
CHECKPOINT=${NAVSIM_DEVKIT_ROOT}/models/dp_baseline.ckpt
CACHE_PATH=${NAVSIM_DEVKIT_ROOT}/cache/${TRAIN_TEST_SPLIT}_metric_cache
agent=gtrs_diffusion_policy
subscore_folder=dp_subscore_baseline_${TRAIN_TEST_SPLIT}
experiment_name=dp_baseline_${TRAIN_TEST_SPLIT}

export DP_PREDS=none
export SUBSCORE_PATH=${NAVSIM_EXP_ROOT}/${subscore_folder}/dp_baseline_subscore_${TRAIN_TEST_SPLIT}.pkl # save path for the dp-generated trajectories
