...
class TransfuserAgent(AbstractAgent):
    ...
    def __init__(
        ...
        self._feature_builders = [TransfuserFeatureBuilder(config=self._config)]
    ...
    def initialize(self) -> None:
        ...
        strict = not self._config.use_lora
        ...
        new_state_dict = {k.replace("agent.", ""): v for k, v in state_dict.items()}
