...
def main(cfg: DictConfig) -> None:
    ...
    if os.getenv("SYN_IDX", None) is not None and hasattr(agent, "load_pdm_score_syn"):
        agent.load_pdm_score_syn()
    ...
    wandb_name = cfg.experiment_name + "/" + cfg.experiment_uid
    ...
    if isinstance(agent, TransfuserAgent):
        trainer = pl.Trainer(**cfg.trainer.params, logger=wandb_logger, callbacks=agent.get_training_callbacks())
    else:
        trainer = pl.Trainer(
            **cfg.trainer.params,
